 ...
 * @brief  LCD 时钟初始化
 * @note
 * @param  loopDiv: 设置loopDivider寄存器
 * @param  prediv: 设置LCDIF_PRE分频
 * @param  div: 设置LCDIF分频
 * @retval None
 */
static void  lcdclk_init (unsigned char  loopDiv, unsigned char  prediv, unsigned char  div)
{
	/* 先初始化video pll
...
/**
 * @brief  结束复位 ELCDIF 接口
 * @note
 * @retval None
 */
static void  lcd_noreset (void)
{
